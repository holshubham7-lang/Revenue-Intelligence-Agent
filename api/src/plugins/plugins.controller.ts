...
export class PluginsController {
  ...
  async connect(
    ...
    await this.pluginsService.startConnection(userId, slug);
    // OAuth handoff is implemented per connector by the adapters layer.
    return { status: 'pending', authUrl: null };
  }
